...
BuildArch:      noarch
BuildRequires:  php54-pear >= 1:1.4.9-1.2

Requires(post): %{__pear}
Requires(postun): %{__pear}
Requires:       php54-pear(DB) >= 1.4.0
Requires:       php54-pear(PEAR) >= 1.4.3
Requires:       php54-domxml-php4-php5
...
%changelog
* Wed Feb 01 2017 SWAELENS Jonathan <jonathan@opensides.be> - 1.1.1-1
